...
export const UPORT_URL = 'http://192.168.0.6:3000'; // (Bhushan - local uport Node server)
...
export const NODE_URL_CHAT = "http://192.168.0.6:3040";  // (Bhushan - local Spring server)
