...
export const AWS_EC2_IP = 'http://15.206.166.57:';
export const AWS_URL = AWS_EC2_IP + '3030'; // (Bhushan - cognito AWS server)
export const BLOCKCHAIN_URL = 'http://54.84.126.44:5000'; //(Khemraj - Python Server)
export const UPORT_URL = AWS_EC2_IP + '3000'; // (Bhushan - uport Node server)
export const SPRING_URL = AWS_EC2_IP + '8090';  // (Bhushan - Spring server)
export const SPRING_AVG_RATE_URL = 'http://192.168.0.18:5000'; //(AVG RATE)
export const NODE_URL_CHAT = AWS_EC2_IP + '3040';
//*/